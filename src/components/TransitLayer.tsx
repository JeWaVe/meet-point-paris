      ...
      line.branches.map((branch, bi) => {
        ...
        return (
          <Polyline
            ...
            pathOptions={{
              color: line.color,
              weight: line.type === 'rer' ? 4 : line.type === 'tram' || line.type === 'cable' || line.type === 'funicular' ? 2 : 3,
              opacity: line.type === 'tram' || line.type === 'cable' || line.type === 'funicular' ? 0.7 : 0.85,
              dashArray: line.type === 'rer' ? '8 4' : line.type === 'tram' ? '4 3' : line.type === 'cable' || line.type === 'funicular' ? '2 6' : undefined,
            }}
          >
